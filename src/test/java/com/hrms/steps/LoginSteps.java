...
public class LoginSteps extends CommonMethods {
	...
	public void user_see_text_on_login_page(String errText) {
		...
		public void i_enter_empty_username_and_valid_passwordand_see_error_massage(DataTable emptyCredentials) {
		    List<Map<String,String>> list=  emptyCredentials.asMaps();
		    for(Map<String,String>map:list) {
				...
				sendText(login.username, username);
				sendText(login.password, password);
				sendText(login.errorMsg, errorM);
		    }
		}
}
